    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            name: "list",
            description: "List Sieve scripts (with optional per-account activation)",
            flags: [
              { name: "account", short: "a", type: "string", help: "Account email or UUID" },
            ],
          },
          {
            name: "view",
          ...
          },
          {
            ...
            flags: [
              { name: "account", short: "a", type: "string", help: "Account email or UUID (required)" },
            ],
          },
          {
            name: "deactivate",
