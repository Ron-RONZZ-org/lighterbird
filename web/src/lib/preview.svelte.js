 ...
 *
 * Usage:
 *   import { showPreview } from "./preview.svelte.js";
 *   await showPreview(content, format);
 *     → opens PreviewDialog with the rendered HTML
 *
 ...
 * Falls back to the shared preview URL (not letter-specific).
 */
