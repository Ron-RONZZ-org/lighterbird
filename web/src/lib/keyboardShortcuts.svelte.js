/**
 * Shared keyboard shortcut registry for lighterbird.
 *
 ...
 *   4. Browser defaults
 *
 * Neovim-common key priority:
 *   i = focus command input (already global)
 *   h = toggle help (already global)
 *   q = close tab (already global)
 *
 ...
 *
 * @param {string} scope   — component identifier (e.g. "EmailListTab", "TodoViewTab")
 * @param {Array<{key: string, desc: string, modifiers?: string}>} items
 */
